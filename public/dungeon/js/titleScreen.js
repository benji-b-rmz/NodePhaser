...
titleScreen.prototype = {
	...
	create: function(){
		...
		this.titleText = this.game.add.text(this.world.width/2, this.world.height/2, this.titleString, this.titleTextStyle);
		this.titleText.anchor.set(0.5);

		this.playText = this.game.add.text(this.world.width/2, this.world.height * 2/3, "PLAY", this.menuTextStyle);
